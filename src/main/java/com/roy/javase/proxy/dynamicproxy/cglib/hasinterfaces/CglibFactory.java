...
import com.roy.javase.proxy.dynamicproxy.cglib.nointerface.SomeService;
...
public class CglibFactory implements MethodInterceptor {
    ...
    public ISomeService getCglibCreator(){
        //实例增强器
        ...
        ISomeService proxy = (ISomeService) enhancer.create();
        return proxy;
    }
